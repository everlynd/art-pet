...
exports.appendChildrens = exports.generateUrl = exports.generateId = void 0;
...
const generateUrl = (str) => {
    ...
    res = res.replace(/\ ? /g, '-') + "-" + Math.random().toFixed(3).slice(2).replace(/\./g, '');
    return res;
};
exports.generateUrl = generateUrl;
const appendChildrens = (array, products) => {
    var _a, _b;
    let result = [];
    ...
    for (let i = 0; i < array.length; i++) {
        if (array[i].parentId) {
            products.forEach(item => {
                if (item.categoryId === array[i].id) {
                    array[i].itemsCount += 1;
                }
            });
            (_b = (_a = result.find(elem => elem.id === array[i].parentId)) === null || _a === void 0 ? void 0 : _a.children) === null || _b === void 0 ? void 0 : _b.push(array[i]);
        }
    }
    return result;
};
exports.appendChildrens = appendChildrens;
